      ...
      <div class="row">
        <div class="col s12">
          <div    class="icon-block second applyContainer">
            <h2 class="center blue-text"><i class="material-icons co1">today</i></h2>
            <h4 class="center">{{$t("Regist.title")}}</h4>
            <!--<p class="light">-->
            <div style="margin-top:40px; " >
              <p style="font-weight: 700;font-size: x-large">————</p>
              <h5>Information</h5>
              <ul class="collection">
                <li class="collection-item"><i class="large material-icons ">chevron_right</i>{{$t("Regist.duration")}} : {{$t("Regist.duration1")}}</li>
                <li class="collection-item"><i class="large material-icons ">chevron_right</i>{{$t("Regist.link")}} : <a href="https://coscup2018.kktix.cc/events/coscup2018regist">{{$t("Regist.link1")}}</a></li>
